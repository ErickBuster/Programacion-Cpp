...
void eliminarTodosNodosLista(Nodo *&, int &);
void delay(int);
...
int main(){
    ...
    while(1){
        ...
        case 4:
            ...
            break;
        case 5:
            cout << "\nTodos los elementos eliminados " << endl;
            while(Lista != NULL){
                eliminarTodosNodosLista(Lista, numero);
                cout << numero;
                cout << (Lista != NULL ? " -> " : " -> NULL");
            }
            delay(2);
            break;
        case 6:
...
void eliminarTodosNodosLista(Nodo *&Lista, int &dato){
    //Paso 1
    Nodo *aux = Lista;
    //Paso 2
    dato = aux->dato;
