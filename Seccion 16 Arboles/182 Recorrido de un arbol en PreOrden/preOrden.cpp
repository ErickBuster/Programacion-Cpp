...
(raiz, izquierda, derecha). para recorrer un arbol
binario no vacio en preOrden, hay que realizar las
siguientes operaciones recursivamente en cada nodo
comenzando con el nodo de raiz
    1. visite la raiz
    2. atraviese el sub-arbol izquierdo
    3. atravises el sub-arbol derecho 
    
    1. crear funcion
    2. checar si el arbol esta vacio
    3. mostrar raiz
    4. llamar de nuevo la funcion y mostrar la raiz izq
    5. llamar de nuevo la funcion y mostrar la raiz der */
#include <iostream>
#include <stdlib.h>
#include <time.h>
using namespace std;
