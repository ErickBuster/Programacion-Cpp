...
(izquierda, derecha, raiz). para recorrer un arbo 
binario no vacio en postOrden, hay que realizar las
siguientes operaciones recursivamente en cada nodo
    ...
    1. Crear la funcion
    2. checar si el arbol no esta vacio
    3. llamar a la funcion recursiva y recorrer el lado izquierdo
    4. llamar a la funcion recursiva y recorrer el lado derecho
    5. mostrar el dato */
#include <iostream>
#include <stdlib.h>
#include <time.h>
